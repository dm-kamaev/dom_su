...
const STORE_SPB = {
    ...
    schedule: {
        ...
        text: "<p>Наши постоянные клиенты, которые заключили договор на постоянные уборки, получают от нашей компании скидки на <b>мытье окон 15%</b> и на <b>генеральную уборку не менее 35%</b>.</p>",
        preview_pic: "promotion-schedule.svg",
        picture: "promotion-schedule-main.svg",
        id: "schedule",
        promo: "1 час бесплатно",
    ...
    birthday: {
        title: "День рождения",
        text: "<p>Мы любим наших клиентов и любим дарить подарки. Если у Вас День Рождения, как нашему постоянному клиенту мы подарим Вам <a href=''>Поддерживающую уборку</a> бесплатно. Закажите ее за один день перед своим днем рождения или один день после.</p>",
        preview_pic: "promotion-birthday.svg",
        picture: "promotion-birthday-main.svg",
        id: "birthday",
        promo: "Поддерживающую уборку бесплатно",
