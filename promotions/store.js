...
const STORE_WWW = {
  new_certificate: {
     title: "Новогодние подарочные сертификаты",
     text: "<p>Не знаете что подарить близким и друзьям на Новый год? Подарите порядок и уют! У нас Вы можете приобрести новогодние подарочные сертификаты на любые услуги в Комфорт-сервисе “Домовенок”, номиналом 2500/3500/5000 рублей. Для покупки сертификата обратитесь в отдел продаж - <a href='tel:+74956680468'>8 (495) 668-04-68</a>.</p>",
     preview_pic: "promotion-new-certificate.svg",
     picture: "promotion-new-certificate-main.png",
     id: "new_certificate",
     promo: "",
     preview: "Не знаете что подарить близким и друзьям на Новый год? Подарите порядок и уют! ..."
   },
  reviews: {
